...
import { EMediumStatus, ENavItemType, ENavs, TNav, TNavContext, TNavItem } from 'web/src/types/app'
import { useTranslation } from 'react-i18next'
import { ETrans } from 'web/src/types/translations'
import { useDragContext, useSelectionContext } from 'web/src/providers'
import useAddToFavorites from 'web/src/hooks/add-to-favorites'
import useSetMediaStatus from 'web/src/hooks/set-status'
