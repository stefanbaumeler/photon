...
import { useDetailsContext, useSearchContext } from 'web/src/providers'
...
import { Drawer } from 'web/src/components/Drawer'
import { FilmStrip, GalleryView, Medium } from 'web/src/components'
