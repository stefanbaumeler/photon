...
import { ELayout, EMediumStatus, ESelectionMode } from 'web/src/types/app'
import { useState } from 'react'
import { useDetailsContext, useLayoutContext, useSelectionContext } from 'web/src/providers'
